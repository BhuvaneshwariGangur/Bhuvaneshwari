...
public class SportRunner {
	...
	public static void main(String[] args) {
		...
		System.out.println("running main in sports");
		
		String name="Cricket";
		
		Floor floor0=new Floor("ground floor", 0);
		...
		Floor[] floors = {floor0, floor1, floor2, floor3,floor4};
		...
		Corporator corporator = new Corporator("cc patil", buildings);
		Corporator corporator1 = new Corporator("Tejaswi Surya", buildings);
		Corporator corporator2 = new Corporator("yadiyurappa", buildings);
		...
		Player player1 = new Player("Chahal", 35, building, town);
